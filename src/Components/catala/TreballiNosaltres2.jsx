            ...
            <div className="mx-auto mt-10 grid max-w-2xl lg:mx-0 lg:max-w-none grid-cols-3 lg:gap-x-10 xl:gap-x-14">
                <div className="flex flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center"> 
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Salari competitiu</h3>
                    </div>  
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Reconeixem el valor i el temps de dedicació amb què contribueix a l'èxit de l'empresa.</p>
                </div>
                ...
                <div className="flex flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Incentius significatius</h3></div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Recompensem i valorem positivament l’esforç extraordinari i el rendiment individual destacat.</p>
                </div>
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center"> 
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Assegurança de salut</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Un paquet complet per cobrir les necessitats mèdiques i promoure un enfocament integral del seu benestar físic i mental.</p>
                </div>
            </div>
            ...
            <div className="mx-auto mt-10 grid max-w-2xl lg:mx-0 lg:max-w-none grid-cols-3 lg:gap-x-10 xl:gap-x-14">
                ...
                <div className="flex flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Flexibilitat horària</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Adapteu la jornada laboral com us convingui, treballant a partir d'objectius i no per hores de dedicació.</p>
                </div>
                ...
                <div className="flex flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Modalitat a distància</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Llibertat per prendre decisions amb les quals equilibrar la vostra feina i la vostra vida personal.</p>
                </div>
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    ...
                    <h3 className="font-semibold text-blue-400 lg:tracking-tighter xl:tracking-normal lg:text-[19px] xl:text-xl">Política il·limitada de vacances</h3></div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Us recomanem com a mínim un mes de vacances, però confiem en la gestió de la vostra autonomia per descansar i gaudir de la vostra vida.</p>
                </div>
            </div>
            <GradientDividerUniversal className="from-blue-950 to-blue-950 mt-10"/>
            ...
            <div className="mx-auto mt-10 grid max-w-2xl lg:mx-0 lg:max-w-none grid-cols-3 lg:gap-x-10 xl:gap-x-14">
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl lg:tracking-tighter xl:tracking-normal">Desenvolupament professional</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Oportunitats per adquirir noves habilitats, assumir nous reptes, avançar en l'assumpció de responsabilitats, gestionar l'eficiència i el rendiment de l'equip.</p>
                </div>
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center"> 
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Formació contínua</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Us donarem suport i guiarem en cada pas que fareu en el viatge sense fi que és mantenirse actualitzat en les últimes tendències i tecnologies que us permetran assolir els vostres objectius professionals.</p>
                </div>

                <div className="flex flex-col lg:gap-x-0 xl:gap-x-4 xxs:py-6 lg:py-1 xl:p-1">
                    <div className="flex lg:gap-x-0 xl:gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold lg:tracking-tighter  2xl:tracking-normal text-blue-400 lg:text-[17px] text-[19px]">Participació en esdeveniments externs</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Construirem el <span className='font-italic'>networking</span> necessari per aprendre i enriquir la nostra xarxa professional de col·laboradors assistint a jornades, conferències, congressos, etc.</p>
                </div>
            </div>           
            <GradientDividerUniversal className="from-blue-950 to-blue-950 mt-10"/>
            ...
            <div className="mx-auto mt-10 grid max-w-2xl lg:mx-0 lg:max-w-none grid-cols-3 lg:gap-x-10 xl:gap-x-14">
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Entreteniment digital</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Us proporcionem accés a plataformes d'entreteniment digital de primer nivell per gaudir de moments de relaxació per desconnectar i recarregar energies.</p>
                </div>
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Premsa a la carta</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Respectant la diversitat d'interessos, us oferim subscripcions perquè personalitzeu la vostra experiència de lectura i us mantingueu informats segons les vostres preferències i curiositats.</p>
                </div>
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 24 24" className='mt-1 text-blue-400'>
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Tecnologia d'avantguarda</h3></div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Impulsem la vostra productivitat proporcionant accés a equips d'avantguarda i eines digitals avançades per garantir una experiència laboral eficient i actualitzada.</p>
                    </div>
                </div>
        ...
        return(
            ...
            <div className='relative mt-0 z-10 xxs:block xs:mt-10 sm:mt-0 lg:hidden px-5'>
                ...
                <div className="mx-auto md:mt-10 xxs:flex xxs:flex-col xxs:gap-5 max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left"> 
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl">Salari competitiu</h3></div>  
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Reconeixem el valor i el temps de dedicació amb què contribueix a l'èxit de l'empresa.</p>
                    </div>
                    ...
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Incentius significatius</h3></div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tighter">Recompensem i valorem positivament l’esforç extraordinari i el rendiment individual destacat.</p>
                    </div>
                ...
                <div className="mx-auto xxs:mt-5 sm:mt-0 md:mt-10 xxs:flex xxs:flex-col xxs:gap-5 max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left"> 
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Assegurança de salut</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Un paquet complet per cobrir les necessitats mèdiques i promoure un enfocament integral del seu benestar físic i mental.</p>
                    </div>
                    ...
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Flexibilitat horària</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Adapteu la jornada laboral com us convingui, treballant a partir d'objectius i no per hores de dedicació.</p>
                    </div>
                </div>
                ...
                <div className="mx-auto xxs:mt-5 sm:mt-0 md:mt-10 xxs:flex xxs:flex-col xxs:gap-5 max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Modalitat a distància</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Llibertat per prendre decisions amb les quals equilibrar la vostra feina i la vostra vida personal.</p>
                    </div>
                ...
                <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                    ...
                    <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl">Política il·limitada de vacances</h3></div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Us recomanem com a mínim un mes de vacances, però confiem en la gestió de la vostra autonomia per descansar i gaudir de la vostra vida.</p>
                </div>
                </div>
                ...
                <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                    <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Desenvolupament professional</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Oportunitats per adquirir noves habilitats, assumir nous reptes, avançar en l'assumpció de responsabilitats, gestionar l'eficiència i el rendiment de l'equip.</p>
                </div>
                ...
                <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                    <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left"> 
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Formació contínua</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Us donarem suport i guiarem en cada pas que fareu en el viatge sense fi que és mantenirse actualitzat en les últimes tendències i tecnologies que us permetran assolir els vostres objectius professionals.</p>
                </div>
                </div>
                ...
                <div className="mx-auto xxs:mt-5 sm:mt-0 md:mt-10 xxs:flex xxs:flex-col xxs:gap-5 max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 xxs:text-[18px] xs:text-xl sm:text-2xl">Participació en esdeveniments externs</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Construirem el networking necessari per aprendre i enriquir la nostra xarxa professional de col·laboradors assistint a jornades, conferències, congressos, etc.</p>
                    </div>
                    ...
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Tecnologia d'avantguarda</h3></div>
                            <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Impulsem la vostra productivitat proporcionant accés a equips d'avantguarda i eines digitals avançades per garantir una experiència laboral eficient i actualitzada.</p>
                        </div>
                ...
                <div className="mx-auto xxs:mt-5 sm:mt-0 md:mt-10 xxs:flex xxs:flex-col xxs:gap-5  max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Premsa a la carta</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Respectant la diversitat d'interessos, us oferim subscripcions perquè personalitzeu la vostra experiència de lectura i us mantingueu informats segons les vostres preferències i curiositats.</p>
                    </div>
                    ...
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Entreteniment digital</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Us proporcionem accés a plataformes d'entreteniment digital de primer nivell per gaudir de moments de relaxació per desconnectar i recarregar energies.</p>
                    </div>
                </div>
...
export default TreballiNosaltres2