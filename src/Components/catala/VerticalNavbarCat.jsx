...
function VerticalNavbarCat() {
  ...
  return (
    <div class="z-50 flex flex-col fixed bottom-[30%] left-[4%] transform -translate-x-1/2 mx-auto justify-between w-10 rounded-3xl space-y-3 xxs:hidden lg:block">
      ...
      <Tooltip content="Inici" placement='right' className='text-blue-950 dark:text-white text-2xl'>
        <Button >
          <NavLink href="/catala">
      ...
      <Tooltip content="Introducció" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button >
          <NavLink href="/catala/#introduccio">
      ...
      <Tooltip content="Missió" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button >
          <NavLink href="/catala/#missio">
      ...
      <Tooltip content="Els nostres valors" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button >
          <NavLink href="/catala/#nostresvalors">           
      ...
      <Tooltip content="Mapa Conceptual" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button >
          <NavLink href="/catala/#mapaconceptual">
      ...
      <Tooltip content="Contacte" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button >
          <NavLink href="/contacte">
      ...
      <Tooltip content="Oportunitats laborals" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button >
          <NavLink href="/contacte/#treballinosaltres">
...
export default VerticalNavbarCat