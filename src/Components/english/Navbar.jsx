    ...
    <Popover> 
      ...
      <Transition.Root> 
        ...
        > 
          ...
          > 
            <h1 href="#features" className="block w-full p-2 text-center">Web map</h1> 
            ...
            <div className="flex flex-row place-items-center hover:text-pink-500 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/english" className="">Home</MobileNavLink>
            </div>
            <div className="flex flex-row place-items-center hover:text-cyan-400 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/english/#introduction" className="">Introduction</MobileNavLink> 
            </div>  
            <div className="flex flex-row place-items-center hover:text-green-400 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/english/#mission" className="">Mission</MobileNavLink> 
            </div>
            <div className="flex flex-row place-items-center hover:text-yellow-300 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/english/#ourvalues" className="">Our values</MobileNavLink>
            </div>
            <div className="flex flex-row place-items-center hover:text-red-500 max-w-[190px] mx-auto">
              ...
              <MobileNavLink href="/english/#roadmap" className="">Conceptual map</MobileNavLink>
            </div>
            <div className="flex flex-row place-items-center hover:text-orange-500 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/contact" className="">Contact</MobileNavLink>
            </div>
            <div className="flex flex-row place-items-center hover:text-violet-500 max-w-[240px] mx-auto">
              ...
              <MobileNavLink href="/contact/#workwithus" className="">Work with us</MobileNavLink>
            </div>
          </Popover.Panel> 
        </Transition.Child> 
      </Transition.Root> 
