  ...
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(props.animated ? headerAnimation : {})}>
        <AppScreen.Title>Contact by <span className='text-[#25D366]'>WhatsApp</span></AppScreen.Title>
        <AppScreen.Subtitle>
      ...
      >
        <div className="px-4 py-6">
          ...
          <div className="space-y-6 text-center text-gray-700 font-extrabold text-lg pt-4 pb-2">
            <p>Start a conversation and we will respond as quickly as possible.</p>
          </div>
...
function ContactoTelegram(props) {
  return (
    <AppScreen className="w-full">
    <MotionAppScreenHeader {...(props.animated ? headerAnimation : {})}>
      <AppScreen.Title>Contact by <span className='text-[#2AA1DA]'>Telegram</span></AppScreen.Title>
      <AppScreen.Subtitle>
         <span className="text-white"></span>       
      </AppScreen.Subtitle>
    </MotionAppScreenHeader>
