    ...
    >
      <FadeIn>
          <div className="mx-auto max-w-7xl text-center">
            ...
            <p className="mt-7 text-center mx-auto xxs:text-[16px] xxs:tracking-tighter sm:tracking-normal dark:tracking-normal xxs:mb-3 xs:text-[17.5px] xs2:text-[18.7px] sm:text-[26px] sm:leading-8 md:text-[31px] md:max-w-3xl lg:mb-0 lg:text-[42px] lg:max-w-5xl xl:max-w-6xl 2xl:max-w-full xl:text-[51px] 2xl:text-[55px] lg:leading-none text-blue-950 dark:text-white">
            Each challenge will be the reason to take<br /> the next step outside your comfort zone; we<br className=' md:block'/> assure you that it'<br className='xxs:hidden '/>ll be worth it, not that it'll be easy.
            </p>
            ...
            Our commitment is to understand and support each other, so if you feel identified with our values, share our mission and think that your profile fits, we would love to meet you!
            </p>
