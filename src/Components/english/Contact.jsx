import FeaturesDesktop from './Mobile'
      ...
      <div className="mx-auto grid max-w-7xl lg:max-w-none xl:max-w-6xl 2xl:max-w-[1350px] grid-cols-1 lg:grid-cols-2 overflow-clip">
        <div className="relative px-5 pb-20 sm:pt-20 lg:static lg:px-8">
          <div className="mx-auto max-w-3xl lg:mx-0 lg:max-w-lg 2xl:max-w-xl">
            ...
            <h2 className="text-2xl tracking-tight xxs:text-center xxs:text-3xl xs:text-[31px] sm:text-5xl md:text-6xl lg:text-left lg:text-[53px] lg:pl-8 xl:pl-0 xl:text-[68px] 2xl:text-7xl bg-clip-text text-transparent bg-[linear-gradient(to_right,theme(colors.blue.300),theme(colors.blue.950),theme(colors.blue.300))] dark:bg-[linear-gradient(to_right,theme(colors.blue.400),theme(colors.blue.100),theme(colors.blue.400))] bg-[length:200%_auto] animate-gradient py-5 mx-auto xs:max-w-md sm:max-w-5xl md:max-w-3xl lg:max-w-5xl xl:max-w-6xl xs:mb-5 md:mb-8 lg:mb-8 xl:mb-10 2xl:mb-12">How can we help?</h2>
            <p className="mt-6 text-blue-950 dark:text-white lg:pl-8 xl:pl-0 texto">
            Whether to resolve doubts or questions about our services, propose a collaboration or share your experience, do not hesitate to contact us<span className='font-avenirBook'>!</span>
            </p>
