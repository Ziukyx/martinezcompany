      ...
      <footer className="bg-white dark:bg-slate-950">
          <div className="mx-auto xxs:max-w-[280px] xs:max-w-[420px] sm:max-w-lg md:max-w-none md:px-5 xxs:py-10 xs:-py-20">
              ...
              <div className="pb-6 md:whitespace-nowrap columns-2 xxs:flex xxs:flex-wrap xxs:justify-center xxs:space-x-1 xs:space-x-3 md:space-x-2" aria-label="Footer">
                  ...
                  <div>
                      <a href='/contact' className="xxs:text-sm xs:text-md leading-6 after:content-['__·'] text-blue-950 hover:text-blue-400 dark:text-gray-300 dark:hover:text-gray-600">
                      Contact
                      </a>
                      
                  </div>
                  <div>
                      <a href='/contact#workwithus' className="xxs:text-sm xs:text-md leading-6 text-blue-950 hover:text-blue-400 dark:text-gray-300 dark:hover:text-gray-600">
              ...
              <p className="xxs:tracking-tighter sm:tracking-normal light:tracking-normal text-center xxs:text-[11px] xs:text-sm leading-5 text-gray-600/90 dark:text-gray-400">
                  Martínez & Company Management & Intermediation &copy; 2024 <span className='xxs:opacity-0 lg:opacity-100'>-</span><br className='lg:hidden'/> All rights reserved.
              </p>
          </div>
      </footer>
    )
