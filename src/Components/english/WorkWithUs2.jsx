            ...
            <div className="mx-auto mt-10 grid max-w-2xl lg:mx-0 lg:max-w-none grid-cols-3 lg:gap-x-10 xl:gap-x-14">
                <div className="flex flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center"> 
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Competitive salary</h3>
                    </div>  
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We recognize the value and time dedication with which you contribute to the success of the company.</p>
                </div>
                ...
                <div className="flex flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Significant incentives</h3></div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We reward and positively value extraordinary effort and outstanding individual performance.</p>
                </div>
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center"> 
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Health insurance</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">A complete package to cover your medical needs and promote a comprehensive approach to your physical and mental wellbeing.</p>
                </div>
            </div>
            ...
            <div className="mx-auto mt-10 grid max-w-2xl lg:mx-0 lg:max-w-none grid-cols-3 lg:gap-x-10 xl:gap-x-14">
                ...
                <div className="flex flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Flexible schedule</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Adapt your working day to your convenience, working towards objectives and not by hours of dedication.</p>
                </div>
                ...
                <div className="flex flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Remote mode</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Freedom to make decisions to balance your work and personal life.</p>
                </div>
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    ...
                    <h3 className="font-semibold text-blue-400 text-xl">Unlimited vacation policy</h3></div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We recommend at least one month of annual leave, but we trust your ability to manage your autonomy to rest and enjoy your life.</p>
                </div>
            </div>
            <GradientDividerUniversal className="from-blue-950 to-blue-950 mt-10"/>
            ...
            <div className="mx-auto mt-10 grid max-w-2xl lg:mx-0 lg:max-w-none grid-cols-3 lg:gap-x-10 xl:gap-x-14">
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Professional development</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Opportunities to acquire new skills, take on new challenges, advance assuming responsibilities, manage team efficiency and performance.</p>
                </div>
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center"> 
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Continuous training</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We support and guide you in every step you take on the endless journey of staying up to date on the latest trends and technologies that will allow you to achieve your professional goals.</p>
                </div>
                ...
                <div className="flex flex-col lg:gap-x-0 xl:gap-x-4 xxs:py-6 lg:py-1 xl:p-1">
                    <div className="flex lg:gap-x-0 xl:gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 lg:text-[19px] xl:text-xl">Participation in external events</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We build the necessary networking from which to learn and enrich our professional network of collaborators by attending meetings, conferences, congresses, etc.</p>
                </div>
            </div>           
            <GradientDividerUniversal className="from-blue-950 to-blue-950 mt-10"/>
            ...
            <div className="mx-auto mt-10 grid max-w-2xl lg:mx-0 lg:max-w-none grid-cols-3 lg:gap-x-10 xl:gap-x-14">
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Digital entertainment</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We provide you with access to world-class digital entertainment platforms to enjoy moments of relaxation with which to disconnect and recharge.</p>
                </div>
                ...
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Press on demand</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">As we respect the diversity of interests, we offer you subscriptions so you can personalize your reading experience and stay informed according to your preferences and curiosities.</p>
                </div>
                <div className="flex  flex-col gap-x-4 xxs:py-6 lg:p-1">
                    <div className="flex gap-x-2 justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 24 24" className='mt-1 text-blue-400'>
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl">Cutting-edge technology</h3></div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We boost your productivity by providing you with access to cutting-edge equipment and advanced digital tools to ensure an efficient and up-to-date work experience.</p>
                    </div>
                </div>
        ...
        return(
            ...
            <div className='relative mt-0 z-10 xxs:block xs:mt-10 sm:mt-0 lg:hidden px-5'>
                ...
                <div className="mx-auto md:mt-10 xxs:flex xxs:flex-col xxs:gap-5 max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left"> 
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl">Competitive salary</h3></div>  
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We recognize the value and time dedication with which you contribute to the success of the company.</p>
                    </div>
                    ...
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Significant incentives</h3></div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tighter">We reward and positively value extraordinary effort and outstanding individual performance.</p>
                    </div>
                ...
                <div className="mx-auto xxs:mt-5 sm:mt-0 md:mt-10 xxs:flex xxs:flex-col xxs:gap-5 max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left"> 
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Health insurance</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">A complete package to cover your medical needs and promote a comprehensive approach to your physical and mental wellbeing.</p>
                    </div>
                    ...
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Flexible schedule</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Adapt your working day to your convenience, working towards objectives and not by hours of dedication.</p>
                    </div>
                </div>
                ...
                <div className="mx-auto xxs:mt-5 sm:mt-0 md:mt-10 xxs:flex xxs:flex-col xxs:gap-5 max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Remote mode</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Freedom to make decisions to balance your work and personal life.</p>
                    </div>
                ...
                <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                    ...
                    <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl">Unlimited vacation policy</h3></div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We recommend at least one month of annual leave, but we trust your ability to manage your autonomy to rest and enjoy your life.</p>
                </div>
                </div>
                ...
                <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                    <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Professional development</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">Opportunities to acquire new skills, take on new challenges, advance assuming responsibilities, manage the team efficiency and its performance.</p>
                </div>
                ...
                <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                    <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left"> 
                        ...
                        <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Continuous training</h3>
                    </div>
                    <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We support and guide you in every step you take on the endless journey of staying up to date on the latest trends and technologies that will allow you to achieve your professional goals.</p>
                </div>
                </div>
                ...
                <div className="mx-auto xxs:mt-5 sm:mt-0 md:mt-10 xxs:flex xxs:flex-col xxs:gap-5 max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl">Participation in external events</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We build the necessary networking from which to learn and enrich our professional network of collaborators by attending meetings, conferences, congresses, etc.</p>
                    </div>
                    ...
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Cutting-edge technology</h3></div>
                            <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We boost your productivity by providing you with access to cutting-edge equipment and advanced digital tools to ensure an efficient and up-to-date work experience.</p>
                        </div>
                ...
                <div className="mx-auto xxs:mt-5 sm:mt-0 md:mt-10 xxs:flex xxs:flex-col xxs:gap-5  max-w-7xl">
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Press on demand</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">As we respect the diversity of interests, we offer you subscriptions so you can personalize your reading experience and stay informed according to your preferences and curiosities.</p>
                    </div>
                    ...
                    <div className="flex justify-center gap-x-2 flex-col xxs:py-3 sm:py-6">
                        <div className="flex gap-x-2 justify-center xxs:text-center sm:text-left">
                            ...
                            <h3 className="font-semibold text-blue-400 text-xl sm:text-2xl ">Digital entertainment</h3>
                        </div>
                        <p className="mt-3 text-blue-950 dark:text-white texto2 tracking-tight">We provide you with access to world-class digital entertainment platforms to enjoy moments of relaxation with which to disconnect and recharge.</p>
                    </div>
                </div>
