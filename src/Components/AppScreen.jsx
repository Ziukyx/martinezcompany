...
export function AppScreen({ children, className, ...props }) {
  return (
    <div className={clsx('flex flex-col -mt-1', className)} {...props}>
...
AppScreen.Header = forwardRef(function AppScreenHeader({ children }, ref) {
  return (
    <div ref={ref} className="px-4 text-white mt-3 mb-5 text-center">
      {children}
    </div>
  )
})
...
AppScreen.Title = forwardRef(function AppScreenTitle({ children }, ref) {
  return (
    <div ref={ref} className="text-2xl mt-0 text-white">
      {children}
    </div>
  )
})
...
AppScreen.Body = forwardRef(function AppScreenBody(
  ...
  return (
    <div
      ref={ref}
      className={clsx('mt-5 flex-auto rounded-t-2xl bg-white', className)}
    >
      {children}
    </div>
  )
