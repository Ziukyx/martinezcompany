...
function VerticalNavbar() {
  ...
  return (
    <div class="z-50 flex flex-col fixed bottom-[30%] left-[4%] transform -translate-x-1/2 mx-auto justify-between w-10 rounded-3xl space-y-3 xxs:hidden lg:block">
      ...
      <Tooltip content="Inicio" placement='right' className='text-blue-950 dark:text-white text-2xl'>
      ...
      <Tooltip content="Introducción" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button aria-label="Introducción">
          <NavLink href="/#introduccion">
      ...
      <Tooltip content="Misión" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button aria-label="Misión">
          <NavLink href="/#mision">
      ...
      <Tooltip content="Valores" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button aria-label="Valores">
          <NavLink href="/#nuestrosvalores">           
      ...
      <Tooltip content="Mapa conceptual" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button aria-label="Mapa conceptual">
          <NavLink href="/#mapaconceptual">
      ...
      <Tooltip content="Contacto" placement='right' className="text-blue-950 dark:text-white text-2xl">
      ...
      <Tooltip content="Oportunidades laborales" placement='right' className="text-blue-950 dark:text-white text-2xl">
        <Button aria-label="Oportunidades loborales">
          <NavLink href="/contacto/#trabajanosotros">
