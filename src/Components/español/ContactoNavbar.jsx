...
import { MobileNavIcon, MobileNavLink } from "./NavbarEsp"
        ...
        > 
          ...
          > 
            ...
            <div className="flex flex-row place-items-center hover:text-pink-500 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/" className="">Inicio</MobileNavLink>
            </div>
            <div className="flex flex-row place-items-center hover:text-cyan-400 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/#introduccion" className="">Introducción</MobileNavLink> 
            </div>  
            <div className="flex flex-row place-items-center hover:text-green-400 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/#mision" className="">Misión</MobileNavLink> 
            </div>
            <div className="flex flex-row place-items-center hover:text-yellow-300 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/#nuestrosvalores" className="">Valores</MobileNavLink>
            </div>
            <div className="flex flex-row place-items-center hover:text-red-500 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/#mapaconceptual" className="">Hoja de ruta</MobileNavLink>
            </div>
            <div className="flex flex-row place-items-center hover:text-orange-500 max-w-[150px] mx-auto">
              ...
              <MobileNavLink href="/contacto" className="">Contacto</MobileNavLink>
            </div>
            <div className="flex flex-row place-items-center hover:text-violet-500 max-w-[270px] mx-auto">
...
export function ContactoNavbar() {  
  return (  
